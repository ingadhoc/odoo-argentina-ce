...
class AccountArVatLine(models.Model):
    ...
    vat_per = fields.Monetary(readonly=True, string="VAT Perc.", currency_field="company_currency_id")
    not_taxed = fields.Monetary(readonly=True, string="Not taxed/ex", currency_field="company_currency_id")
    other_taxes = fields.Monetary(readonly=True, currency_field="company_currency_id")
