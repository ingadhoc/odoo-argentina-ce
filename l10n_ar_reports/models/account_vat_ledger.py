...
# citi / libro iva digital methods
    ...
    def get_point_of_sale(self, invoice):
        pos_number = invoice._l10n_ar_get_document_number_parts(
                invoice.l10n_latam_document_number, invoice.l10n_latam_document_type_id.code)['point_of_sale']
        return "{:0>5d}".format(pos_number)
    ...
    def get_REGINFO_CV_CBTE(self, alicuotas):
        ...
        for inv in invoices:
            ...
            row = [
                ...
                "{:0>20d}".format(self.get_invoice_number(inv))
            ]
            ...
            if self.type == 'sale':
                ...
                row.append("{:0>20d}".format(self.get_invoice_number(inv)))
            else:
