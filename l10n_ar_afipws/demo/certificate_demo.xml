...
<odoo>
    <record id="main_company_certificate_alias" model="afipws.certificate_alias">
        <field name="common_name">AFIPWShomologationYourCompany14092018</field>
        <field name="key">-----BEGIN PRIVATE KEY-----
...
-----END PRIVATE KEY-----</field>
        ...
        <!-- <field name="state_id" ref="l10n_ar_account.demo_S"/> -->
        <field name="city">Rosario</field>
        <field name="service_provider_cuit">20313932975</field>
        <field name="service_type">outsourced</field>
        <!-- <field name="company_cuit">30111111118</field> -->
        <!-- <field name="service_type">in_house</field> -->
        <field name="type">homologation</field>
        <field name="state">confirmed</field>
    </record>

    <record id="main_company_certificate" model="afipws.certificate">
        <field name="alias_id" ref="main_company_certificate_alias"/>
        <field name="state">confirmed</field>
        <field name="csr">-----BEGIN CERTIFICATE REQUEST-----

-----END CERTIFICATE REQUEST-----</field>
        <field name="crt">-----BEGIN CERTIFICATE-----
MIIDSTCCAjGgAwIBAgIIccwT10Q4O5kwDQYJKoZIhvcNAQENBQAwODEaMBgGA1UEAwwRQ29tcHV0
YWRvcmVzIFRlc3QxDTALBgNVBAoMBEFGSVAxCzAJBgNVBAYTAkFSMB4XDTIzMTAzMDE5MTYzMloX
DTI1MTAyOTE5MTYzMlowLzESMBAGA1UEAwwJT2Rvb0NlcnQzMRkwFwYDVQQFExBDVUlUIDIwMzEz
...

-----END CERTIFICATE-----
</field>
    </record>
</odoo>
